...
storage_account_access_key = 'OM4+/m3W5myxo6RR7YsMMJhHwg7z6LWlWmD0cmkBUNcUFgcxez'
...
def baby_names_raw():
  ...
  filePath = "wasbs://" + blob_container + "@" + storage_account_name + ".blob.core.windows.net/Baby_Names__Beginning_2007.csv"
